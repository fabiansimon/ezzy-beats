...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=EzzyBeat Demo Installer\n"
      else:
        line="OutputBaseFilename=EzzyBeat Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the EzzyBeat Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the EzzyBeat installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=EzzyBeat Demo installer\n"
     else:
       line="SetupWindowTitle=EzzyBeat installer\n"
